...
playground theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of playground theme and run the following commands:
`nvm use`
...
`drush en playground -y`
`drush config-set system.theme default playground -y`
